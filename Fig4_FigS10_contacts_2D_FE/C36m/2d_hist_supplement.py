...
df = pd.read_csv('contacts_dimer_C36m.csv')/2 # avoid double counting
df = df.iloc[6000:] # 60ns of equilibration for a99SBdisp
...
ax.set_title('jR2R3 P301L dimer: C36m',fontsize=16)
...
plt.savefig('2dhist_C36m.png',dpi=300)
plt.show()
