...
# use two decimal points on y-ticks
ax.yaxis.set_major_formatter(plt.matplotlib.ticker.StrMethodFormatter('{x:,.2f}'))
plt.yticks(np.arange(1,1.04,0.01))
plt.ylim(bottom=1,top=1.025)
plt.text(0.5,1.0075,'a03ws',fontsize=12,ha='center',color=colors[0],rotation=-25)
plt.text(0.5,1.013,'a99SBdisp',fontsize=12,ha='center',color=colors[1],rotation=-35)
plt.text(0.5,1.0015,'CHARMM36m',fontsize=12,ha='center',color=colors[2],rotation=-10)
plt.text(0.5,1.022,'waters are freed\nupon docking',ha='center',color='gray',fontsize=11)
plt.tight_layout()
plt.savefig('obs_box_3body_rel_tetra.png',dpi=300)
...
plt.ylabel("water tetrahedrality\nin dashed box",fontsize=18)
...
ax.set_xticklabels(['y=20-24Å\n(undocked)','y=5-10Å\n(docked)'],fontsize=15)
plt.yticks(fontsize=15)
plt.ylabel(r"$p_{tet}$ in dashed box",fontsize=18)
plt.ylim(bottom=0, top=0.007)
plt.legend(loc='upper center' ,fontsize=15)