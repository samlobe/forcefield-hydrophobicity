...
# protein_file = 'minimized_a99SBdisp.pdb'
# protein_file = 'minimized_C36m.pdb'
protein_file = 'minimized_a03ws.pdb'
...
def coulomb_energy(chainA_scale, chainB_scale):
...
chainA_coulomb = coulomb_energy(1, 0)
chainB_coulomb = coulomb_energy(0, 1)
print(f"Total coulombic potential energy:\n{total_coulomb}")
print(f"Chain A coulombic potential energy:\n{chainA_coulomb}")
print(f"Chain B coulombic potential energy:\n{chainB_coulomb}")
print(f"Chain Interaction coulombic potential energy:\n{total_coulomb - chainA_coulomb - chainB_coulomb}")
